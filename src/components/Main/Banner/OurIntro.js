    ...
    <div className={styles.wrap}>
      <Fade>
        ...
        <div className={styles.text}>
          ...
          <span>
            동그라미는 우아한 애자일에서 개발했으며
            <br />
            현재도 인덕대학교 학생들을 위한 서비스를 개발중입니다.
          </span>
        </div>
      </Fade>
    </div>
